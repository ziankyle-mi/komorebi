...
function WidgetCustomizerSection({
  ...
  const themes = [{
    ...
    desc: 'Rose Gold & Midnight'
  }, {
    id: 'forest',
    name: 'Emerald Dusk',
    color: '#6ee7b7',
    glow: 'rgba(52, 211, 153, 0.25)',
    desc: 'Mint Emerald Glass'
  }, {
    id: 'ocean',
    name: 'Celestial Azure',
    color: '#38bdf8',
    glow: 'rgba(56, 189, 248, 0.25)',
    desc: 'Starry Cyan Starlight'
  }, {
    id: 'gilded',
    name: 'Gilded Gold',
    color: '#f8cf65',
    glow: 'rgba(248, 207, 101, 0.25)',
    desc: 'Obsidian & Gold Trim'
  }, {
    id: 'minimal',
    name: 'OLED Pure',
    color: '#e2e8f0',
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, currentThemeObj.name)), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: '10px',
      color: 'var(--text-secondary)',
      marginTop: '2px'
  ...
  }, localConfig.showCycle && /*#__PURE__*/React.createElement("div", {
    style: {
      flex: 1,
  ...
  }, "Cycle Sanctuary")), localConfig.showPhoto && /*#__PURE__*/React.createElement("div", {
    style: {
      flex: 1,
    ...
    key: 'showNote',
    label: 'Daily Whisper Note',
    icon: '💌'
  }, {
    key: 'showPhoto',
    label: 'Shared Photo & Video Locket',
    icon: '📷'
  }, {
    key: 'showCycle',
    label: 'Cycle Sanctuary Status & Phase',
    icon: '🌸'
...
window.ChatTab = ChatTab;
  ...
  // ==========================================
  // Module: www/js/views/LockscreenView.jsx
  // ==========================================
/**
...
function LockscreenView({
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: `lockscreen-viewport widget-theme-${themeKey} widget-radius-${cornerRadius}`
  }, window.CelestialPhysicsCanvas && /*#__PURE__*/React.createElement(CelestialPhysicsCanvas, {
    theme: themeKey === 'forest' ? 'forest' : themeKey === 'ocean' ? 'ocean' : 'pink'
  }), /*#__PURE__*/React.createElement("div", {
    className: "lockscreen-clock-card"
  }, /*#__PURE__*/React.createElement("div", {
    className: "lockscreen-time"
  }, liveTime), /*#__PURE__*/React.createElement("div", {
    className: "lockscreen-date"
  }, new Date().toLocaleDateString('en-US', {
    weekday: 'long',
    month: 'long',
    day: 'numeric'
  }))), (showMood || showNote) && /*#__PURE__*/React.createElement("div", {
    className: "glance-widget-surface"
  }, showMood && /*#__PURE__*/React.createElement("div", {
    className: "glance-partner-badge"
  }, /*#__PURE__*/React.createElement("img", {
  ...
  }, partnerTraveler.name), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: '10.5px',
      color: partnerMoodData.color,
      fontWeight: '700',
      display: 'flex',
      alignItems: 'center',
      gap: '4px',
  ...
  }, /*#__PURE__*/React.createElement(MoodVectorIcon, {
    moodId: partnerMood,
    size: 11
  }), /*#__PURE__*/React.createElement("span", null, partnerMoodData.name, " Mood"))), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: '10px',
      background: 'rgba(255,255,255,0.06)',
      padding: '3px 8px',
  ...
  }, isSleeping ? '💤 Resting' : `⚡ ${myEnergy * 10}%`)), showNote && /*#__PURE__*/React.createElement("div", {
    className: "glance-note-bubble"
  }, /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: '9px',
      textTransform: 'uppercase',
  ...
  }, "\"", whisperNote || 'Tap Edit to write a note', "\""))), showCycle && cycleState && /*#__PURE__*/React.createElement("div", {
    className: "glance-widget-surface",
    style: {
      padding: '10px 14px'
    }
    ...
    style: {
      fontSize: '9px',
      background: `${cycleState.phaseColor || '#fca5c9'}22`,
      color: cycleState.phaseColor || '#fca5c9',
      padding: '1px 5px',
      borderRadius: '5px',
      fontWeight: '700'
    }
  }, "Day ", cycleState.currentCycleDay)), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: '9.5px',
      color: 'var(--text-secondary)'
    }
  }, cycleState.phaseName))), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: '10px',
      color: '#fca5c9',
      fontWeight: '700'
    }
  }, cycleState.phaseKey === 'menstrual' ? 'Period Active' : `Period in ${cycleState.daysUntilNextPeriod}d`))), showPhoto && /*#__PURE__*/React.createElement("div", {
    ...
    size: 12
  }), /*#__PURE__*/React.createElement("span", null, partnerTraveler.name, "'s Photo Drop")), latestSnap && /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: '9.5px',
      color: 'var(--text-secondary)'
    }
  }, latestSnap.time)), /*#__PURE__*/React.createElement("div", {
    className: "glance-photo-body"
  }, /*#__PURE__*/React.createElement(MediaCarouselViewer, {
    snap: latestSnap,
    activeTraveler: activeTraveler,
    partnerTraveler: partnerTraveler,
    ...
    className: "lockscreen-unlock-bar",
    onClick: onUnlock
  }, /*#__PURE__*/React.createElement("span", null, "Swipe up or tap to enter sanctuary"), /*#__PURE__*/React.createElement("div", {
    className: "unlock-handle-pill"
  })));
}
...
function AndroidApp() {
  ...
  const [widgetConfig, setWidgetConfig] = useState(() => window.loadStorage ? window.loadStorage('widget_config', {
    theme: 'sakura',
    style: 'glass',
  ...
  }, [activeTraveler, partnerTraveler, myAvatar, partnerAvatar, plans, messages, latestSnap, whisperNote, myEnergy, isSleeping, selectedRingtone, myMood, partnerMood, chatTheme, isLockscreenEnabled, isNotificationsEnabled, isNotifSoundEnabled, cycleSettings, cycleLogs, widgetConfig]);
